...
#    for timeStart, timeNow in zip(pd.date_range(end=pd.Timestamp(year=2010, month=6, day=15), start=pd.Timestamp(year=1999, month=7, day=15), freq='MS'), pd.date_range(end=pd.Timestamp(year=2010, month=12, day=15), start=pd.Timestamp(year=2000, month=1, day=15), freq='MS')):
    for timeStart, timeNow in zip(pd.date_range(end=pd.Timestamp(year=2019, month=11, day=15), start=pd.Timestamp(year=2018, month=5, day=15), freq='MS'), pd.date_range(end=pd.Timestamp(year=2020, month=5, day=15), start=pd.Timestamp(year=2018, month=11, day=15), freq='MS')):
        t =time.time()
        ...
        startYear = timeStart.year
        startMont = timeStart.month
