...
script_file='HSAF_regrid_RZSM_v4_op.py'
...
echo "--------------------> Regrid H14 data in the last $dayback days, up to $time_now"
...
python $script_file -t $time_now -d $dayback > log/bol-h14_regrid.txt
