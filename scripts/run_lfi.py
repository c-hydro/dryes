...
# run it as follows:
# python path/to/here/run_lfi.py -options "path/to/options.json" -time_start "YYYY-MM-DD" -time_end "YYYY-MM-DD"
# or
# python path/to/here/run_lfi.py -options "path/to/options.json" -time "YYYY-MM-DD"

def main():
    options = get_options()
    this_spi = LFI(options['index'], options['io'])
