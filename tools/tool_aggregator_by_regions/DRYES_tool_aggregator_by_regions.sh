...
# Execution example:
# python3 dryes_tool_aggregator_by_regions.py -settings_file "dryes_tool_daily_aggregator_by_regions.json" -time_now "yyyy-mm-dd HH:MM"
#-----------------------------------------------------------------------------------------

#-----------------------------------------------------------------------------------------
# Get file information
script_file='dryes_tool_aggregator_by_regions.py'
settings_file='dryes_tool_daily_aggregator_by_regions.json'
