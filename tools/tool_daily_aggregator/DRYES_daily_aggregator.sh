...
#-----------------------------------------------------------------------------------------
# Script information
script_name='DRYES daily aggregator of hourly rasters'
...
# Execution example:
# python3 dryes_tool_daily_aggregator.py -settings_file "dryes_tool_daily_aggregator.json" -time_now "yyyy-mm-dd 00:00"
#-----------------------------------------------------------------------------------------
